...
import 'package:nche/view/feed/reward/verified_evidence.dart';
import 'package:nche/view/feed/widget/grid_image.dart';
import 'package:nche/widget/colors.dart';
import 'package:nche/widget/style.dart';

import '../widget/news_menu_sheet.dart';

class RewardPostWidget extends StatelessWidget {
  final int index;
  //final List post;
  final bool isNewsDetail;
  final BuildContext context;
  final bool iscompleted;
  const RewardPostWidget({
    Key? key,
          ...
          iscompleted
              ? TextButton(
                  onPressed: () => Navigator.push(
                        context,
                        CupertinoPageRoute(
                          builder: (_) => const RewardVerifiedEvidence(),
                        ),
                      ),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
              ...
              : Row(
                  children: [
                    ...
                    Text(
                      'Uwani Police, has verified this claim',
                      style: style.copyWith(
                        fontSize: 13,
                        color: AppColor.lightBlack.withOpacity(0.8),
